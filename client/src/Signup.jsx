...
export default function Signup() {
  ...
  return (
    <div className="w-[600px] bg-slate-50   mx-auto font-sans mt-28 p-2">
      ...
      <h1 className="w-full max-w-xs mx-auto font-sans text-cyan-700 text-[26px] font-medium   capitalize p-2">Register</h1>
  ...
  >
    ...
    <div className="mb-6">
      ...
      />
      <p className="text-rose-500 text-xs italic hidden">Please choose a password.</p>
    </div>
    <div className="flex items-center justify-between">
      ...
      <Link className="inline-block align-baseline font-light text-sm text-cyan-700 hover:text-cyan-900" to='/login'>
          Login
        </Link>
    </div>
  </form>
